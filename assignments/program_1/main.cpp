...
* @Description:
*     This program reads rgb structured files for an image. It also allows
*     manipulation of said image through different functions that manipulate the
*     .txt file in order to change the image in different ways, such as flipping it
*      horizontally, vertically, or grayscaling the image.
*     
...
* @Description: 
*     This function flips the rgb values to flip the image vertically.
* @Params:
*    rgb** image - 2D array holding rgb values
*    int width - width of image
*    int height - height of image
...
* @Description: 
*     This function flips the rgb values to flip the image horizontally.
* @Params:
*    rgb** image - 2D array holding rgb values
*    int width - width of image
*    int height - height of image
